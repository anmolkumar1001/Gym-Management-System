...
<body>
<div class="jumbotron" style="background: url('pic/trainer.jpg') no-repeat;background-size: cover;height: 350px;"></div>	
...
<div class="card">
    ...
    <a href="admin-panel.php" class="btn btn-outline-primary">Go Back</a>
            ...
            <div class="col-md-3"><h3 style="font-family: 'Lobster', cursive;" >Trainer Information</h3></div>
            <div class="col-md-8">
